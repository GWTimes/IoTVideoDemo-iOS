...
struct IVCSEvent: Codable {
    ...
    /// 原图后缀, 完整路径：imgUrl = imgUrlPrefix + imgUrlSuffix
    var imgUrlSuffix: String?
    /// 缩略图后缀, 完整路径：thumbUrl = imgUrl + thumbUrlSuffix，即thumbUrl = imgUrlPrefix + imgUrlSuffix + thumbUrlSuffix
    var thumbUrlSuffix: String?
}
