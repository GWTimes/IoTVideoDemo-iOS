...
class IVLoginViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        // 测试配置
        tmpSecretKeyTF.text = IVConfigMgr.cfgValue(forKey: "IOT_TEST_SECRECT_KEY")
        tmpSecretIDTF.text  = IVConfigMgr.cfgValue(forKey: "IOT_TEST_SECRECT_ID")
        userNameTF.text     = IVConfigMgr.cfgValue(forKey: "IOT_TEST_USER_NAME")
    }
